        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="{{ route('category.create') }}" aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="{{ route('subcategory.create') }}" aria-expanded="false">
							<i class="fa fa-th"></i>
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="{{ route('product.create') }}" aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="{{ route('product.color') }}" aria-expanded="false">
							<i class="fa fa-list"></i>
							<span class="nav-text">Variation Manager</span>
						</a>
                        <ul aria-expanded="false">
							<li><a href="{{ route('product.color') }}">Colors</a></li>
                            <li><a href="{{ route('product.size') }}">Sizes</a></li>
						</ul>
                    </li>
                    <li>
                        <a class="has-arrow ai-icon" href="{{ route('banner.create') }}" aria-expanded="false">
							<i class="fa fa-picture-o"></i>
							<span class="nav-text">Banner</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('banner.create') }}">Banner Add</a></li>
							<li><a href="{{ route('banner.index') }}">Banner List</a></li>
						</ul>
                    </li>
                    <li><a href="{{ route('order') }}" class="ai-icon" aria-expanded="false">
                    ...
                    <li><a href="{{ route('coupon.create') }}" class="ai-icon" aria-expanded="false">
                            <i class="fa fa-money"></i>
                            <span class="nav-text">Coupon</span>
                        </a>
                    </li>
                    <li><a href="{{ route('index') }}" class="ai-icon" aria-expanded="false" target="_blank">
				...
				{{-- <div class="copyright">
					<p><strong>Pranto's Admin Dashboard</strong> © 2021 All Rights Reserved</p>
					<p>Made with <span class="heart"></span> by MokaromPranto</p>
				</div> --}}
			</div>
        </div>
        <!--**********************************
...
***********************************-->
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="{{ route('home') }}" target="_blank">MokaromPranto</a> 2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end
