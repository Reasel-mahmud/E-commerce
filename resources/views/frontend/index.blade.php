            ...
            @foreach ($categories as $category)
                <div class="d-none col-12 col-lg-4 center-col mb-md-30px mb-lm-30px mb-3 category_div">
                    <div class="single-banner-2">
                        <img src="{{ asset('uploads/category') }}/{{ $category->category_photo }}" alt="not found">
                        <div class="item-disc">
                            <h4 class="title">Best Collection <br>
                                For {{ $category->category_name }}</h4>
                            <a href="{{ route('category.details', $category->slug) }}" class="shop-link btn btn-primary">Shop Now <i class="fa fa-shopping-basket ml-5px" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
            @endforeach
                ...
                <div class="col-lg-4">
                    <div class="single-blog">ne
                        ...
                        <div class="blog-text">
                            ...
                            <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.html">Contrary to popular belieflo lorem Ipsum is not</a></h5>
