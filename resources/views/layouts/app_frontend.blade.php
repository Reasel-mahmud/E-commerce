...
<head>
    ...
    <title>Single Vendor- Fashoin eCommerce HTML Template</title>
                    ...
                    <div class="col align-self-center d-none d-lg-block">
                        <div class="main-menu">
                            <ul>
                                ...
                                <li><a href="{{route('shop')}}">Shop</i></a></li>
                                <li><a href="#">About</i></a></li>
                                <li><a href="{{ route('cart') }}">Cart</i></a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- Header Action Start -->
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <p class="copy-text"> © 2021 <strong>Jesco</strong> Made With <i class="fa fa-heart"
                                    aria-hidden="true"></i> By <a target="_blank"class="company-name" href="https://facebook.com/mokarom.pranto2">
                                    <strong> MH Pranto</strong></a>.</p>
                        </div>
                    </div>
                </div>
            </div>
